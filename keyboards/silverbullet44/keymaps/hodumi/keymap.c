 ...
 */
  [_QWERTY] = LAYOUT(
    ...
    KC_TAB,  KC_Z, KC_X, KC_C, KC_V, KC_B,                KC_N,   KC_M,    KC_COMM, KC_DOT, KC_SLSH, KC_AT,
             KC_LALT, CTL_T(KC_SPC), SFT_T(KC_SPC), LOWER,    CTL_T(KC_BSPC), RAISE, SFT_T(KC_ENT), KC_RALT
  ),
 ...
 * |-----+------+----+-----+-----+-------|                                  |------+------+------+------+------+------|
 * | Esc | F6  | F7  | F8  | F9  | F10   |                                  | PgDn | Left | Down |Right | End  |      |
 * |-----+-----+-----+-----+-----+-------+                                  +------+------+------+------+------+------|
 * | Esc | F11 | F12 |     |     | PrtScr|------------.------.  ,------------------|      |      |      |      |      |      |
 * `-----------------------------------------/       /       /   \       \      \----------------------------------------'
 ...
 */
  ...
  KC_ESC , KC_F6 , KC_F7 , KC_F8  , KC_F9  , KC_F10 ,                           KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, KC_END , XXXXXXX,
  KC_ESC , KC_F11, KC_F12, XXXXXXX, KC_PSCR, XXXXXXX,                           XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
 ...
 */
  [_RAISE] = LAYOUT(
   KC_ESC, KC_1 ,  KC_2 , KC_3 , KC_4 , KC_5,                        XXXXXXX, XXXXXXX, KC_LBRC, KC_RBRC, KC_MINS, XXXXXXX,
   KC_ESC, KC_6 ,  KC_7 , KC_8 , KC_9 , KC_0,                        KC_EQL , XXXXXXX, KC_LPRN, KC_RPRN, KC_QUOT, XXXXXXX,
   KC_ESC, KC_00, XXXXXXX , XXXXXXX, XXXXXXX, KC_ESC,               KC_BSLS, KC_GRV , XXXXXXX, XXXXXXX, KC_AT  , KC_AT  ,
